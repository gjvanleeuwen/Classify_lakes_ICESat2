...
if __name__ == "__main__":
    ...
    if empirical:
        ...
        empirical_df_red = pd.read_csv(
            pth.get_files_from_folder(os.path.join(data_dir, 'empirical'), '*1222*green.csv')[0])
        empirical_df_green = pd.read_csv(
            pth.get_files_from_folder(os.path.join(data_dir, 'empirical'), '*1222*red.csv')[0])
...
# slices = [slice(11460000 - 10000, 11500000),
#          slice(13425000, 13460000),
#          slice(13225000 + 15000,13225000+25000)]
#
# slices2 = [slice(8790000,8815000), slice(10550000, 10550000+25000)]
#
# slices3 = [slice(13465000-75000, 13485000)]
#
