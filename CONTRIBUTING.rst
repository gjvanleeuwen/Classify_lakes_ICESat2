...
Welcome to ``ICESat_lake_classification`` contributor's guide.
...
If you experience bugs or general issues with ``ICESat_lake_classification``, please have a look
...
You can help improve ``ICESat_lake_classification`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``ICESat_lake_classification`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``ICESat_lake_classification``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n ICESat_lake_classification python=3 six virtualenv pytest pytest-cov
    conda activate ICESat_lake_classification
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/ICESat_lake_classification.git
    cd ICESat_lake_classification
...
#. Install |pre-commit|_::
   ...
   ``ICESat_lake_classification`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/ICESat_lake_classification
.. _issue tracker: https://github.com/<USERNAME>/ICESat_lake_classification/issues
.. <-- end -->
